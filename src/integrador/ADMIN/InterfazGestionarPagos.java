 ...
 * @author pache
 */
public class InterfazGestionarPagos extends javax.swing.JFrame {

    /**
     * Creates new form InterfazAdmin
     */
    public InterfazGestionarPagos() {
        initComponents();
        transparenciabutton();
    }
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID PAGO", "TIPO", "VALOR PAGO", "FECHA PAGO", "ID DEUDA"
            }
        ) {
        ...
        jLabel4.setText("GESTIONAR PAGOS");
    ...
    private void botoneditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botoneditarActionPerformed
        // TODO add your handling code here:
        InterfazModificarPago modificarpagos=new InterfazModificarPago();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazGestionarPagos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazGestionarPagos().setVisible(true);
            }
        });
    }
