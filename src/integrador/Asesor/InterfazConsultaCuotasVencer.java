 ...
 * @author pache
 */
public class InterfazConsultaCuotasVencer extends javax.swing.JFrame {

    /**
     * Creates new form InterfazAdmin
     */
    public InterfazConsultaCuotasVencer() {
        initComponents();
        transparenciabutton();
    }
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID DEUDA", "NOMBRE", "CELULAR", "CORREO", "VALOR CUOTA", "FECHA VENCIMIENTO"
            }
        ) {
        ...
        jLabel4.setText("CUOTAS A VENCER");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazConsultaCuotasVencer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazConsultaCuotasVencer().setVisible(true);
            }
        });
    }
