 ...
 * @author pache
 */
public class InterfazConsultaMisventas extends javax.swing.JFrame {

    /**
     * Creates new form InterfazAdmin
     */
    public InterfazConsultaMisventas() {
        initComponents();
        transparenciabutton();
    }
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID VENTA", "MATRICULA", "METODO PAGO", "VALOR VENTA", "CEDULA CLIENTE", "FECHA"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazConsultaMisventas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazConsultaMisventas().setVisible(true);
            }
        });
    }
