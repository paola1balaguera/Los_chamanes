 ...
 * @author pache
 */
public class InterfazConsultaPagos extends javax.swing.JFrame {

    /**
     * Creates new form InterfazAdmin
     */
    public InterfazConsultaPagos() {
        initComponents();
        transparenciabutton();
    }
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID PAGO", "TIPO DE PAGO", "VALOR PAGO", "FECHA", "CEDULA CLIENTE", "ID DEUDA"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazConsultaPagos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazConsultaPagos().setVisible(true);
            }
        });
    }
