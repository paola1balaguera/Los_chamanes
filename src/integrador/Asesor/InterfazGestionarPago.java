 ...
 * @author pache
 */
public class InterfazGestionarPago extends javax.swing.JFrame {

    /**
     * Creates new form InterfazAdmin
     */
    public InterfazGestionarPago() {
        initComponents();
        transparenciabutton();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pago chiquito.png"))); // NOI18N

        jLabel4.setFont(new java.awt.Font("Segoe UI", 2, 24)); // NOI18N
        jLabel4.setText("GESTIONAR PAGO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazGestionarPago.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazGestionarPago().setVisible(true);
            }
        });
    }
