 ...
 * @author pache
 */
public class InterfazCrearAdmin extends javax.swing.JFrame {

    /**
     * Creates new form InterfazAdmin
     */
    public InterfazCrearAdmin() {
        initComponents();
        transparenciabutton();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazCrearAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazCrearAdmin().setVisible(true);
            }
        });
    }
