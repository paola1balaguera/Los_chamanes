 ...
 * @author pache
 */
public class InterfazGestionarAsesor extends javax.swing.JFrame {

    /**
     * Creates new form InterfazAdmin
     */
    public InterfazGestionarAsesor() {
        initComponents();
        transparenciabutton();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("GESTIONAR ASESOR");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazGestionarAsesor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazGestionarAsesor().setVisible(true);
            }
        });
    }
