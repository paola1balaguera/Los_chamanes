 ...
 * @author pache
 */
public class InterfazModificarAdmin extends javax.swing.JFrame {

    /**
     * Creates new form InterfazAdmin
     */
    public InterfazModificarAdmin() {
        initComponents();
        transparenciabutton();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("MODIFICAR ADMIN");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazModificarAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazModificarAdmin().setVisible(true);
            }
        });
    }
